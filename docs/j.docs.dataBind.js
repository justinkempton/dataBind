	...
	, Methods : [
		{
			...
			, Description : [
				...
				+ " to myself the simple idea of associating data to DOM elements which made sense in my head"
				+ " made as much sense written out in code form."
				, "DOM elements with dynamic content get bound to a 'data path'. Paths can be explicitly updated"
				+ " which triggers "
				+ " the associated elements to update. "
				...
				+ " not wanting to loose any long term ability at complexity I decided on giving templated elements"
				+ " a try. This system currently allows for multiple data point associations. This allows a select"
				+ " input to function. An array of items, and the selected item. When either value changes the "
				+ " elements associated with the data will change."
